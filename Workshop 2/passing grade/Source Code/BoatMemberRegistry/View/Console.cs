...
namespace BoatMemberRegistry.View
{
    class Console
    {
        ...
        public void DisplayMainMenu()
        {
            ...
            this.displayInputCharacters("Enter ", "e", " to edit/view an existing member and it's boats.");
            ...
            this.setPossibleInputActions(new List<InputAction>() { new InputAction("l", View.ActionEnum.MemberListCompact),
                                                                    new InputAction("v", View.ActionEnum.MemberListVerbose),
                                                                    new InputAction("a", View.ActionEnum.MemberAdd),
                                                                    new InputAction("e", View.ActionEnum.MemberSelection)});
        }
        ...
        public void DisplayDetailedMemberPresentation(Model.Member member, bool clearView = true)
        {
            if (clearView)
            {
                System.Console.Clear();
            ...
            //set the current possible input
            this.setPossibleInputActions(new List<InputAction>() { new InputAction("a", View.ActionEnum.MemberAdd),
                                                                    new InputAction("e", View.ActionEnum.MemberEdit),
                                                                    new InputAction("d", View.ActionEnum.MemberDelete)},
        ...
        public void DisplayChangeMemberMenu(Model.Member selectedMember, bool clear = true)
        {
            if (clear)
            {
                System.Console.Clear();
            ...
            //set the current possible input
            List<InputAction> possibleActions = new List<InputAction>() { new InputAction("a", View.ActionEnum.MemberAdd),
                                                                            new InputAction("v", View.ActionEnum.MemberPresentation),
                                                                            new InputAction("e", View.ActionEnum.MemberEdit),
                                                                            new InputAction("g", View.ActionEnum.MemberBoatAdd),
                                                                            new InputAction("d", View.ActionEnum.MemberDelete)};
            if (selectedMember.BoatCount > 0) 
            {
                possibleActions.Add(new InputAction("h", View.ActionEnum.MemberBoatSelectionEdit));
                possibleActions.Add(new InputAction("j", View.ActionEnum.MemberBoatSelectionDelete)); 
            }

            this.setPossibleInputActions(possibleActions, 
                                         View.ActionEnum.MemberSelection);
        }
